...
filename = './REPORT_OUTPUT/HMS/PRODUCTION/replay_hms_coin_production_%s_%s.report'% (runNo, evenNo)
...
for line in f:
    ...
    data2 = line.split('=')
    if ('Ps' in data2[0] and 'factor' in data2[0]  and 'Ps5' not in data2[0] and 'Ps6' not in data2[0]):
        line = data2[0]
        ...
        line = line.replace('Ps4_factor','Pre-Scale HMS 3/4')
