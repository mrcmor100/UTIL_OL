...
{ 
  ...
  TFile *f2 = new TFile(Form("ROOTfiles/hms_coin_replay_production_%d_%d.root",run,nevents));      // no golden
...
void hodo(Int_t runNumber, Int_t eventNumber)
{
  ...
  TFile *f4 = new TFile(Form("ROOTfiles/hms_coin_replay_production_%d_%d.root",run,nevents));//Current Rootfile
